...
export default async function(ctx) {
  ...
  // TCP 热身，不使用 await 保持并发吞吐
  ctx.http.get("https://speed.cloudflare.com/__down?bytes=0", { timeout: 1500 });
  ...
  const speedMbps = `${(40000 / (Date.now() - startTime)).toFixed(1)} Mbps`;
