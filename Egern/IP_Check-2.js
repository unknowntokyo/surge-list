...
export default async function(ctx) {
  ...
  // 🛠️ 动态生成 5 路并发请求，每路下载 1MB (1048576 字节)
  ...
  .then(() => {
    // 🛠️ 常数更新：5路 * 1MB = 5MB = 40Mbit -> 40000
