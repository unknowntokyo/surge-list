...
function testYTB() {
  return new Promise(resolve => {
    ...
    $task.fetch(option).then(response => {
      ...
      console.log(`[YT] 支持${ARROW}${regionCode}`);
      resolve();
    }, () => {
